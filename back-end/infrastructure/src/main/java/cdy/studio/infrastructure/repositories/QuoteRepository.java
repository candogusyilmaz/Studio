...
public interface QuoteRepository extends JpaRepository<Quote, Integer>, JpaSpecificationExecutor<Quote> {
    ...
    @Query("UPDATE Quote q SET q.status = cdy.studio.core.enums.QuoteStatus.PENDING, q.statusResetDate = null " +
            "WHERE q.status = cdy.studio.core.enums.QuoteStatus.SHOWN " +
