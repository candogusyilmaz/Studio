package dev.cdy.studio.api.features.location;

import com.google.common.base.Preconditions;
import dev.cdy.studio.api.exceptions.NotFoundException;
import dev.cdy.studio.api.features.location.dtos.CreateLocation;
...
import dev.cdy.studio.api.features.location.repositories.LocationRepository;
import dev.cdy.studio.api.features.location.repositories.LocationSpecifications;
...
public class LocationService {
    ...
    public LocationInfo getById(int id) {
        return new LocationInfo(locationRepository.findBy((root, query, cb) -> cb.equal(root.get("id"), id), r -> r.project("parent").first()
